...
function ReviewScreen() {
  ...
  if (!documentId) {
    return <p className="p-8 text-sm">No document selected. <Link href="/drive" className="underline">Back to Drive</Link></p>;
  }
  ...
  return (
    <div className="h-screen flex flex-col bg-[#f8f9fa] text-[#1f1f1f]">
      <header className="min-h-14 px-3 sm:px-5 py-2 flex flex-wrap items-center gap-2 sm:gap-3 border-b border-[#e1e3e1]/60 bg-white sticky top-0 z-20">
        <Link href="/drive" className="flex items-center gap-1.5 text-sm text-[#444746] hover:text-[#1f1f1f] px-2 py-1.5 rounded-lg hover:bg-[#f0f4f9]">
          <ArrowLeft className="w-4 h-4" /> <span className="hidden sm:inline">{t("common.back", "Back")}</span>
        </Link>

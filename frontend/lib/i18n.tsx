...
export const STATIC_TRANSLATIONS: Record<Locale, Record<string, string>> = {
  ...
  mr: {
    // Check extracted data (Workbench queue) -- DRAFT Marathi, needs native review
    "check.title": "काढलेली माहिती तपासा",
    "check.tabs_label": "काय तपासायचे",
    "check.tab.unsure": "खात्री नसलेली मूल्ये",
    "check.tab.unsure_desc": "संगणकाने वाचलेली पण खात्री नसलेली मूल्ये. सर्वात कमी खात्रीची सर्वात वर.",
    "check.tab.handwritten": "हस्तलिखित",
    "check.tab.handwritten_desc": "हस्ताक्षरातून वाचलेली मूल्ये — छापील मजकुरापेक्षा यात चुका जास्त होतात.",
    "check.tab.margin": "समासातील टीपा",
    "check.tab.margin_desc": "सारणीबाहेर, बहुधा समासात लिहिलेल्या टीपा, शिक्के किंवा शेरे.",
    "check.tab.join": "न जुळलेल्या ओळी",
    "check.tab.join_desc": "दोन समोरासमोरच्या पानांवर छापलेल्या नोंदवहीतील, डाव्या पानावरची ओळ उजव्या पानावरच्या भागाशी जुळवता आली नाही.",
    "check.tab.stitch": "सारणी पुढील पानावर चालू?",
    "check.tab.stitch_desc": "सारणी पुढील पानावर चालू राहते का हे संगणकाला ठरवता आले नाही. तुमचे उत्तर अशाच मांडणीच्या पुढील सर्व कागदपत्रांसाठी लक्षात ठेवले जाईल.",
    "check.kind.margin_note": "समासात लिहिलेली टीप",
    "check.kind.join_mismatch": "ओळीचे डावे व उजवे भाग जुळले नाहीत",
    "check.kind.stitch": "सारणी पुढील पानावर चालू राहते का?",
    "check.sure.high": "जास्त",
    "check.sure.medium": "मध्यम",
    "check.sure.low": "कमी",
    "check.sure.suffix": "खात्री",
    "check.sure.unknown": "मूल्यांकन नाही",
    "check.shortcuts": "कीबोर्ड शॉर्टकट",
    "check.key.move": "यादीत वर-खाली जा",
    "check.key.open": "पानावर दाखवा",
    "check.key.correct": "बरोबर म्हणून नोंदवा",
    "check.key.handwritten": "हस्तलिखित म्हणून नोंदवा",
    "check.key.claim": "तुम्ही तपासत आहात हे इतरांना कळवा",
    "check.guide.title": "हे कसे वापरायचे",
    "check.guide.1": "संगणकाने ही मूल्ये स्कॅन केलेल्या पानांवरून वाचली आहेत, पण ती बरोबर वाचली की नाही याची त्याला खात्री नाही.",
    "check.guide.2": "एक निवडा आणि मूळ स्कॅनशी तुलना करण्यासाठी “पानावर दाखवा” दाबा.",
    "check.guide.3": "बरोबर असल्यास “बरोबर” दाबा. चुकीचे असल्यास पानाच्या दृश्यात दुरुस्त करा.",
    "check.guide.hide": "ही मदत लपवा",
    "check.items": "नोंदी",
    "check.item_to_check": "तपासायची नोंद",
    "check.items_to_check": "तपासायच्या नोंदी",
    "check.empty": "सध्या येथे तपासण्यासारखे काही नाही.",
    "check.read_only": "तुम्ही ही मूल्ये पाहू शकता, पण तुमच्या भूमिकेला ती नोंदवण्याची किंवा बदलण्याची परवानगी नाही.",
    "check.pick_one": "येथे पाहण्यासाठी यादीतून एक नोंद निवडा.",
    "check.read": "संगणकाने काय वाचले",
    "check.how_sure": "किती खात्री आहे",
    "check.is_handwritten": "हे मूल्य हस्तलिखित आहे.",
    "check.claim.you": "तुम्ही तपासत आहात",
    "check.claim.other": "कोणीतरी तपासत आहे",
    "check.claim.other_long": "हे आधीच दुसरे कोणीतरी तपासत आहे. तुम्ही दुसरी नोंद निवडू शकता.",
    "check.show_on_page": "पानावर दाखवा",
    "check.show_on_page_hint": "हे मूल्य चिन्हांकित केलेले स्कॅन पान उघडते, म्हणजे तुम्ही तुलना करू शकता (की: O)",
    "check.correct": "बरोबर",
    "check.correct_hint": "मूल्य स्कॅनशी तंतोतंत जुळत असेल तरच. चुकीचे मूल्य दुरुस्त करण्यासाठी “पानावर दाखवा” वापरा.",
    "check.mark_handwritten": "हे हस्तलिखित आहे",
    "check.claim": "मी हे तपासत आहे (इतर हे वगळतील)",
    "check.release": "मी हे तपासणे थांबवले",
    "check.claim_hint": "तुम्ही यावर काम करत आहात हे इतर तपासणाऱ्यांना कळते, म्हणजे ते हे वगळतात",
    "check.stitch.question_a": "पान",
    "check.stitch.question_b": "वरील सारणी पुढे पान",
    "check.stitch.yes": "हो, हीच सारणी आहे",
    "check.stitch.side": "ही एका रुंद सारणीचा उजवा भाग आहे",
    "check.stitch.no": "नाही, ही वेगळी सारणी आहे",
    "check.done.correct": "बरोबर म्हणून नोंदवले. ही नोंद यादीतून काढली आहे.",
    "check.done.handwritten": `हस्तलिखित म्हणून नोंदवले. ही आता "हस्तलिखित" टॅबमध्ये आहे.`,
    "check.done.stitch": "उत्तर जतन केले. अशाच मांडणीच्या पुढील कागदपत्रांसाठी ते वापरले जाईल.",
    // Auth
